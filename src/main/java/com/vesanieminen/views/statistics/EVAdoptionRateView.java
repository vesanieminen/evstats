...
public class EVAdoptionRateView extends Main implements HasDynamicTitle {
    ...
    public String getPageTitle() {
        return T.tr("statistics.adoption.title");
    }
    ...
    protected void onAttach(AttachEvent attachEvent) {
        ...
        try {
            ...
            final var evRegistrations = new DataSeries(T.tr("statistics.adoption.bev"));
            final var otherRegistrations = new DataSeries(T.tr("statistics.adoption.other"));
